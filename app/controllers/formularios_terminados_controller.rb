class FormulariosTerminadosController < ApplicationController
  ...
  def responsable_repetido(formularios, formulario_id)
    ...
    @formulario = Formulario.find_by_id(formulario_id)
    for form in formularios
      if (form.responsable.responsabilidad_type == "PersonaJuridica") and (@formulario.responsable.responsabilidad_type == "PersonaJuridica")
      ...
      if (form.responsable.responsabilidad_type == "PersonaJuridicaE") and (@formulario.responsable.responsabilidad_type == "PersonaJuridica")
      ...
      if (form.responsable.responsabilidad_type == "PersonaFisicaENue") and (@formulario.responsable.responsabilidad_type == "PersonaFisicaN")
        ...
        if @persona_fisica_e_nue.num_cuit == @formulario.responsable.responsabilidad.cuil_cuit
          @formularios_con_mismo_responsable_localidad_provincia_y_nombre << form
        end
      end
      ...
      if (form.responsable.responsabilidad_type == "PersonaFisicaEInt") and (@formulario.responsable.responsabilidad_type == "PersonaFisicaENue")
        @id_integrante = form.responsable.responsabilidad.integrante_de_elenco_en_gira_id
        @persona_fisica_e_int = IntegranteDeElencoEnGira.find_by_id(@id_integrante)
